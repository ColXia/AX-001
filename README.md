...
This launches the Tauri desktop application with the room workspace.
...
See [docs/room-core-architecture.md](docs/room-core-architecture.md) for the canonical architecture.
...
The browser-based Web UI is deprecated. The local HTTP server and `web/chatroom/*` modules are internal implementation details for the desktop shell, not a standalone product.
